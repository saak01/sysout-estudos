        ...
        <form method="POST" action="{{url('/veiculos')}}" class="form-group">
            ...
            <select class="form-select" name="model_id" id="" required>
                ...
                @foreach ($models as $model)
                    <option value="{{ $model->id }}">{{ $model->brand_name }} - {{ $model->name }}</option>
                @endforeach
            </select>
            ...
            <div class="row">
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="number" name="model_year" id="year" class="form-control" minlength="1900" required />
                    </div>
                </div>
                <div class="col-6">
                    <div class="form-group">
                        <label for="">Ano Fabricação</label>
                        <input type="number" name="year" id="year" class="form-control" minlength="1900" required />
                    </div>
                </div>
            </div>
            ...
            .<div class="mb-3">
                ...
                <input type="text" name="plate" id="plate" class="form-control" minlength="7" maxlength="7" required/>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="form-check">
                    <input name="optional_id[]" class="form-check-input" type="checkbox" value="{{$optional->id}}" id="{{'optional-'.$optional->id}}">
